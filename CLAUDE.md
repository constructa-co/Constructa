...
> It contains full project context, architecture, rules, and the sprint backlog.
...
To get credentials, ask the project owner or check the `.env.local` file locally.
For Supabase CLI: SUPABASE_ACCESS_TOKEN is set in your shell environment.
New token was generated on 3 April 2026 — obtain from project owner.
