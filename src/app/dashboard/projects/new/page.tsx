                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8 space-y-6">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <textarea
                                ...
                                rows={2}
                                className="w-full px-3 py-2 rounded-lg border border-slate-200 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-600 placeholder:text-slate-400 resize-none"
                            />
                        </div>
                ...
                {step === 2 && (
                    <div className="space-y-6">
                        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8">
                            ...
                            <p className="text-sm text-slate-500 mb-6">Select a starting point for your schedule and estimate. You can customise everything after.</p>
                                    ...
                                    <label key={t.id} className="cursor-pointer group relative block">
                                        ...
                                        <div className="h-full border-2 border-slate-200 peer-checked:border-blue-600 peer-checked:bg-blue-50 peer-checked:ring-1 peer-checked:ring-blue-600 hover:border-blue-300 transition-all cursor-pointer rounded-xl p-5">
                                            <div className="flex items-start justify-between mb-2">
                                                ...
                                                <div className="text-blue-600 opacity-0 peer-checked:opacity-100 flex-shrink-0 ml-2">
                                        ...
                                        {/* Checkmark visible separately because peer-checked only works on direct sibling */}
                                        {form.typeId === t.id && (
