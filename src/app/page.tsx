...
export default function Home() {
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Hero Section */}
      <section className="text-center py-32 px-4 bg-gradient-to-b from-black via-gray-900/50 to-black">
      ...
      <section className="bg-black text-white p-20 text-center">
      ...
      <section className="bg-gradient-to-b from-black via-gray-900/50 to-black p-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className="group p-8 rounded-xl border border-gray-800/50 hover:border-gray-700/50 transition-all duration-500 hover:shadow-xl hover:shadow-gray-900/30 bg-black/50 backdrop-blur-sm">
      ...
      <section className="bg-black text-white p-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 text-center max-w-6xl mx-auto">
          <div className="p-6 rounded-xl border border-gray-800/50 hover:border-gray-700/50 transition-all duration-500 hover:shadow-xl hover:shadow-gray-900/30 bg-black/50 backdrop-blur-sm">
      ...
      <section className="bg-black text-white p-20 text-center">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 rounded-xl border border-gray-800/50 hover:border-gray-700/50 transition-all duration-500 hover:shadow-xl hover:shadow-gray-900/30 bg-black/50 backdrop-blur-sm">
      ...
      {/* About Section */}
      <section id="about" className="bg-gradient-to-b from-black via-gray-900/50 to-black p-20">
      ...
      {/* Contact Section */}
      <section id="contact" className="bg-black text-white p-20 text-center">
        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <form className="w-full max-w-md space-y-6">
            <input 
              type="text" 
              placeholder="Name" 
              className="w-full p-4 bg-black/50 border border-gray-800/50 rounded-xl text-white placeholder-gray-500 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 transition-all duration-300" 
            />
            <input 
              type="email" 
              placeholder="Email" 
            ...
            <button 
              type="submit" 
              className="p-4 bg-orange-600 text-white w-full rounded-xl hover:bg-orange-500 active:bg-orange-700 transition-colors duration-300 font-medium"
            >
              Send Message
            </button>
          </form>
